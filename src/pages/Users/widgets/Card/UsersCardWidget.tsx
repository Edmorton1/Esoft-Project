...
function UsersCardWidget() {
  ...
  useGetBy(`/extendedSearch?tags=${tags}&page=${page}&target=${target}&city=${city}&sex=${sex === 'man' ? 'true' : sex === 'woman' ? 'false' : ''}&min_age=${min_age}&max_age=${max_age}`, {callback: StoreUsers.initial})
